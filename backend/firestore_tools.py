...
def audit_append(case_id: str, agent: str, action: str,
...
def hitl_create(case_id: str, question: str, context: Dict[str, Any], options: List[str]) -> str:
    db = init_db()
